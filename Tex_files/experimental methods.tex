...
\subsection{X-ray Reflectometry (XRD)}\label{sec:XRR}
...
The QCM measurements are subject to inaccuracies in terms of the error in the resonance frequency measurements, which is based on the manufacturer's specifications. The given measurement inaccuracy is 0.03~Hz, which will be taken for error propagation. Additionally, the relative position of the QCM sensor with respect to the ion flux can affect the accuracy of the measurements.\\
