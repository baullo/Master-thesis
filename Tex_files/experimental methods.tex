...
All these variation between pulses are investigated in Sec \ref{sec:errorbar}.\\
 

%%% qcm and below needs to be redone

For the QCM measurements, the error in the resonance frequency measurements is based on the manufacturer's specifications. By propagating the error in the frequency measurements through the Sauerbrey equation, we can estimate the uncertainty in the mass measurements. However, the relative position of the QCM sensor with respect to the ion flux can affect the accuracy of the measurements.\\
