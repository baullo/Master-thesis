...
where $\Delta m$ is the mass change measured by QCM over time interval $\Delta t$, $A_{\text{QCM}} = 1.54$~cm$^2$ is the active crystal area (8~mm diameter), $N_A = 6.022 \times 10^{23}$~mol$^{-1}$ is Avogadro's constant, and $M_{\text{eff}}$ is the effective molar mass calculated from film composition:
