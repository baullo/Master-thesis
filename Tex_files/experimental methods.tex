...
The in-house-built ion collector probe (Figure~\ref{fig:langmuirprobe}) was designed to measure the current density of ions (\(J_i\)) in ion saturation mode. The probe consisted of a 5~mm diameter copper stick milled down to resemble a nail, it was then covered with Katpon tape to ensure insulation from the holder assembly: Fig. \ref{fig:holder assembly}.
