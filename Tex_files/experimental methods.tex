...
where $\Delta m$ is the mass change measured by QCM over $N_{\text{pulses}}$ pulses, $A_{\text{QCM}} = 0.442$~cm$^2$ is the active crystal area, $N_A = 6.022 \times 10^{23}$~mol$^{-1}$ is Avogadro's constant, and $M_{\text{eff}}$ is the effective molar mass of the deposited material.
