...
These kinetic and potential energy components are calculated separately, with total ion energy $E_{tot} = E_{kin} + E_{pot}$ used in the analysis of film growth mechanisms (Chapter~\ref{chap:discussion}). Implementation details of the data processing workflow are provided in Appendix~\ref{appendix:data_workflow}.
