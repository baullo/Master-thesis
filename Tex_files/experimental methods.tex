...
Nitrogen gas (N$_2$, 99.999\% purity) was introduced via a mass flow controller (MKS IO Type B), with chamber pressures monitored using a Pfeiffer PKR 361. The nitrogen flow rate of 1 to 12.8 ccms leads to chamber pressure ranges between 0.025 and 0.3 Pa.\\
...
\end{equation}
where $A = 0.196$~cm$^2$ is the probe collection area and $R = 400~\Omega$ (uncertainties discussed in Appendix~\ref{appendix:uncertainty}).
...
The Sauerbrey relation is accurate as long as $\Delta F \lesssim 0.05 F_q$ (approximately 0.3~MHz for a 6~MHz crystal), for more details on the correction above this limit look in Appendix \ref{long_qcm} and for uncertainties in Appendix~\ref{appendix:uncertainty}. 
