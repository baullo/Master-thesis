...
The processed results were exported to CSV files for correlation with ion probe and QCM measurements and additionally plotted to show the ion energy distribution functions such as figure \ref{fig:ERMS-appendix} for an titanium and aluminum ions.
