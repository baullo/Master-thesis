...
This chapter interprets the experimental findings presented in Chapter~\ref{chap:results} and connects them to the theoretical framework established in Chapter~\ref{chap:theory}. The discussion is organized around two central themes first, the film growth mechanisms, and then second, the plasma transport.
...
\begin{table}[h]
	...
	\begin{tabular}{c c c c c c}
		...
		\midrule
		0.0 & 0.6 & 0.75 & 2.4  & 4.0 $\pm 0.1$ & broad hexagonal peak \\ 
		0.1 & 0.8 & 1.0 & 2.0  & 4.8 $\pm 0.1$& sharp phase cubic peak \\ 
		0.2 & 0.95 & 1.15 & 1.8  & 4.80 $\pm 0.1$& sharp phase cubic peak \\ 
		0.3 & 0.95 & 0.95 & 1.6  & 4.65 $\pm 0.1$& sharp phase cubic peak \\ 
		\bottomrule
	\end{tabular}
\end{table}
...
More accurate film composition measurements using Elastic Recoil Detection Analysis (ERDA) would reduce uncertainties in the effective molar mass $M_{\text{eff}}$ and improve the precision of total flux calculations. ERDA provides direct quantification of light elements like nitrogen without the matrix absorption effects that limit EDX accuracy, potentially revealing systematic compositional trends that are currently obscured by measurement uncertainty.
