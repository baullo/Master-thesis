...
\begin{table}[h]
	...
	\begin{tabular}{c c c c c c}
		...
		0.1 & 0.8 & 1.0 & 2.0  & 4.8 $\pm 0.1$& sharp cubic phase peak \\ 
		0.2 & 0.95 & 1.15 & 1.8  & 4.80 $\pm 0.1$& sharp cubic phase peak \\ 
		0.3 & 0.95 & 0.95 & 1.6  & 4.65 $\pm 0.1$& sharp cubic phase peak \\ 
		\bottomrule
	\end{tabular}
\end{table}
