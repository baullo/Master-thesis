...
\begin{enumerate}
	\item Characterize the ion flux and the atomic flux (flux of all particles arriving at the substrate) as a functions of external magnetic field strength and distance from the macroparticle filter. Furthermore, analyse the ion energy distributions of individual ionic species.
