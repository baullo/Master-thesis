...
\begin{figure}[ht]
	...
	\begin{subfigure}{.5\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption[Mass and ion current vs. nitrogen pressure]{Nitrogen pressure dependence at 14 cm with 0.25 T enhancement. (a) Mass deposition rate exhibits non-monotonic behavior with a local maximum near 0.05~Pa, reflecting competing effects of reactive species incorporation and scattering losses. (b) Ion current behaves similarly with the local maximum near 0.025~Pa}
...
\begin{figure}[h!]
	...
	\caption[Pressure dependence of ion energetics at 10 cm]{Mean charge state (a), average potential energy (b), and average kinetic energy (c) as functions of nitrogen pressure for Al, Ti, and N ions at 10 cm distance and 0.25 T magnetic field.}
...
\begin{figure}[h!]
	...
	\caption[Pressure dependence of ion energetics at 14 cm]{Mean charge state (a), average potential energy (b), and average kinetic energy (c) as functions of nitrogen pressure for Al, Ti, and N ions at 14 cm distance and 0.25 T magnetic field.}
...
Macroparticles are visible on all deposited films, as is typical for filtered cathodic arc deposition despite the 90° magnetic filter geometry described in Chapter~\ref{chap:methods}.
...
\begin{figure}[h]
	...
	\caption[Ion and atomic flux vs. pressure]{Ion flux and atomic flux as functions of nitrogen pressure at 14~cm distance with 0.25~T magnetic field. Error bars represent combined uncertainties from current measurements, charge-state determination (ERMS), and molar mass variations (EDX).}
