...
At 10~cm, the mass deposition rate exhibits non-monotonic pressure dependence, with a local maximum near 0.05--0.1~Pa before decreasing at higher pressures. The ion current shows substantial scatter across the pressure range, with large error bars that overlap between different conditions. A general decreasing trend is evident despite the variability.\\
