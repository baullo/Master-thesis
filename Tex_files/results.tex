...
\begin{subfigure}[b]{\textwidth}
  ...
  \label{fig:3Dion}
\end{subfigure}
\caption[3D visualization of mass flux and ion current]{Three-dimensional visualization of (a) mass deposition rate (ng~cm$^{-2}$~s$^{-1}$) and (b) ion current (mA) as functions of distance (10--20~cm), magnetic field strength (0--0.25~T), and nitrogen pressure (0--0.3~Pa). Measurements performed over 64 arc pulses at 5~Hz repetition rate.}
...
\begin{figure}[h]
	...
	\begin{subfigure}{.5\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption[Metallic mode measurements vs. magnetic field]{Metallic case measurements showing (a) mass flux and (b) the ion current, each plotted as a function of magnetic field strength. Data selected for three distances (10, 14, 20 cm), with error bars representing variation within pulses.}
...
\begin{figure}[ht]
	...
	\begin{subfigure}{.5\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption[Mass and ion current vs. nitrogen pressure]{QCM and Ion Probe measurements showing (a) mass flux and (b) the ion current, each plotted as a function of Pressure. Data shown for representative pressures, with error bars representing variation within pulses.}
...
\begin{figure}[h]
	...
	\caption[ERMS distance dependence in metallic mode]{Mean charge state, potential energy, and kinetic energy as functions of distance in metallic mode (0~Pa, 0.25~T). Al and Ti show mean charge states of $\langle Q \rangle \approx 2.0$ and 2.7 respectively, with minimal variation across 10--20~cm. Total ion energies remain above 40~eV at all distances.}
...
\begin{figure}[h]
	...
	\caption[ERMS distance dependence in reactive mode]{Mean charge state, potential energy, and kinetic energy as functions of distance in reactive mode (0.3~Pa N$_2$, 0.25~T). Metal ion charge states decrease by 20--30\% compared to metallic mode due to charge-exchange collisions. Kinetic energies show increased scatter due to collisional thermalization.}
...
\begin{table}[h]
	\centering
	\caption[Profilometry film thickness measurements]{Profilometry thickness measurements for the deposited films at 14~cm and the two positions where the QCM and Ion probe were before}
...
\begin{figure}[h]
	...
	\caption[XRD patterns for varying nitrogen pressure]{Grazing incidence XRD patterns for Ti--Al and Ti--Al--N films deposited at different nitrogen pressures. Films were deposited at 14~cm distance with 0.25~T magnetic field. The intense peaks between 52$^\circ$ and 57$^\circ$ originate from the Si substrate. Vertical dashed lines indicate reference positions for cubic (Ti$_{0.65}$Al$_{0.35}$)N (111), (200), and (220) reflections at 37.0$^\circ$, 43.0$^\circ$, and 62.5$^\circ$ respectively (ICDD PDF 04-017-5094), as well as hexagonal Ti$_{0.7}$Al$_{0.3}$ (002) at 38.8$^\circ$ (ICDD PDF 04-004-9157).}
...
\begin{table}[h]
	\centering
	\caption[XRR derived thickness]{XRR derived thickness and mass density values for films at QCM and ion current positions}
...
\begin{table}[h]
	\centering
	\caption[Film composition from EDX]{EDX film composition (atomic \%) as a function of nitrogen pressure and the resulting effective molar mass of the films (deposited at 14~cm, 0.25~T)}
	\label{tab:edx}
