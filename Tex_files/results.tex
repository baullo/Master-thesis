...
\begin{table}[h]
	\centering
	\caption[Profilometry film thickness measurements]{Profilometry thickness measurements for the deposited films at the two positions where the QCM and Ion probe were before}
...
\subsection{XRR}\label{sec:results_xrr}
