...
\begin{table}[h]
	\centering
	\caption[XRR derived thickness]{XRR derived thickness and mass density values for films at QCM and ion current positions (samples 10, 11, 13 and 14)}
	\label{tab:xrr_results}
	\begin{tabular}{cccc}
		\toprule
		\multirow{2}{*}{Pressure (Pa)} & \multicolumn{2}{c}{Thickness (nm)} & \multirow{2}{*}{\makecell{Mass density \\ (g/cm$^3$)}} \\
		\cmidrule(lr){2-3}
		& QCM & Ion current & \\
		\midrule
		0.0 & 63 & 58 & 4.00 \\
		0.1 & 46.5 & 38 & 4.80 / 4.75 \\
		0.2 & 42 & 34.5 & 4.80 / 4.75 \\
		0.3 & 45.5 & 39 & 4.65 \\
		\bottomrule
	\end{tabular}
\end{table}
