...
At zero nitrogen pressure, the film exhibits a weak, broad peak at approximately 38.8$^\circ$, consistent with the (002) reflection of hexagonal Ti$_{0.7}$Al$_{0.3}$ (space group P6$_3$/mmc, PDF 04-004-9157). This phase forms as a solid solution with the hexagonal close-packed (hcp) structure, characteristic of Ti-rich Ti--Al alloys in the composition range below 40~at.\% Al \cite{clark1962tial}. The low intensity and broad character suggest limited crystallinity or small crystallite size in the metallic film, typical of vapor-deposited alloys without substrate heating. The absence of the stronger (101) reflection expected at 40.9$^\circ$ (I/I$_{\text{max}} = 100\%$ in the reference pattern) further indicates either preferred orientation with the basal (002) planes parallel to the substrate or incomplete crystallization.

\paragraph{Reactive mode (0.1--0.3~Pa N$_2$):}
Introduction of nitrogen fundamentally alters the film structure. At 0.1~Pa N$_2$, three distinct peaks emerge at approximately 37$^\circ$, 43$^\circ$, and 62$^\circ$, corresponding to the (111), (200), and (220) reflections of the cubic B1 (NaCl-type) (Ti$_{0.65}$Al$_{0.35}$)N phase (space group Fm$\bar{3}$m, PDF 04-017-5094). The appearance of these nitride peaks confirms successful nitrogen incorporation and formation of the metastable cubic structure. Notably, the hexagonal TiAl peak disappears completely, indicating full conversion to the nitride phase rather than coexistence of metallic and nitride domains.\\

As the nitrogen pressure increases to 0.2~Pa and 0.3~Pa, the position precision of all three nitride reflections increases dramatically, indicating improved crystallinity. The (200) peak at 43$^\circ$ is the most prominent reflection, matching the highest relative intensity in the reference pattern (I/I$_{\text{max}} = 1000$) \cite{ICDD_TiAlN}. This suggests that the films develop a random or weakly textured polycrystalline structure as nitrogen pressure increases, approaching the powder diffraction pattern expected for unstressed, randomly oriented crystallites.\\


The close agreement between measured and reference peak positions at higher pressures indicates minimal systematic lattice strain. Small deviations in peak position for 0.1 and 0.2~Pa, arise from compositional variations notably less nitrogen incorporation. The reference cubic nitride exhibits a lattice parameter of $a = 4.202$~\AA\ and a calculated density of 4.8~g\,cm$^{-3}$ \cite{ICDD_TiAlN}, which will be compared with the film densities determined by XRR (Section~\ref{sec:XRR}).

\subsubsection{Comparison with Structure-Zone Model}

The XRD results support the predictions of the Anders structure-zone model \cite{anders2010szm} for plasma-based deposition. In metallic mode, the weak and broad (002) reflection places the film in Zone~1, characterized by limited crystallinity and insufficient adatom mobility for well-ordered growth.\\

Upon nitrogen addition, the combination of chemical driving force (nitride formation enthalpy), energetic ion bombardment (Section~\ref{section:ion_energies}), and enhanced flux (Section~\ref{subsec:mag_field}) collectively promote both complete nitridation and crystallization to the thermodynamically stable cubic structure. This shifts the microstructure from Zone~1 (poorly crystalline) to Zone~T or Zone~2 (dense, well-crystallized) even without external substrate heating.
...
\textbf{Metallic mode (0~Pa):} In vacuum deposition, the film composition reflects the cathode stoichiometry with a Ti:Al ratio of approximately 79:21, which corresponds roughly to the cathode composition (62.8~at.\% Ti; 37.2~at.\% Al). The slight deviation likely arises from differences in erosion rates, ionization efficiencies and transport through the macroparticle filter, between titanium and aluminum. The effective molar mass of 43.5~g$\cdot$mol$^{-1}$ lies between that of pure aluminum (27.0~g$\cdot$mol$^{-1}$) and pure titanium (47.9~g$\cdot$mol$^{-1}$), weighted toward the titanium rich composition.\\


\textbf{Reactive mode (0.1--0.3~Pa N$_2$):} Upon nitrogen introduction, substantial nitrogen incorporation occurs, reaching approximately 33~at.\% at 0.1~Pa and saturating near 39~at.\% at higher pressures. This rapid nitrogen uptake at relatively low pressures indicates efficient reactive deposition, consistent with the formation of TiAlN compound films.\\


The nitrogen saturation above 0.2~Pa suggests that the arrival rate of activated nitrogen species (N$^+$, N$_2^+$, and neutral radicals) exceeds the available metal flux, leading to approximately stoichiometric nitride formation. The final composition at 0.3~Pa (Ti$_{0.47}$Al$_{0.14}$N$_{0.39}$) is close to the composition of the reference material sheet used for XRD analysis \cite{ICDD_TiAlN} with slight nitrogen deficiency.\\


Notably, the Ti:Al ratio decreases from approximately 3.75:1 in metallic mode to approximately 3.4:1 in reactive mode. This shift may reflect preferential sputtering or differential incorporation rates during nitride formation, though the effect is modest compared to the dominant nitrogen incorporation.\\


\textbf{Effective molar mass trends:} The incorporation of nitrogen dramatically reduces the effective molar mass from 43.5~g$\cdot$mol$^{-1}$ (metallic mode) to approximately 32~g$\cdot$mol$^{-1}$ (reactive mode). This $\approx$25\% reduction reflects the displacement of heavy metal atoms (Ti: 47.9~g$\cdot$mol$^{-1}$, Al: 27.0~g$\cdot$mol$^{-1}$) by light nitrogen atoms (14.0~g$\cdot$mol$^{-1}$) in the film composition. The molar mass effectively saturates above 0.2~Pa at $M_{\text{eff}} \approx 31.8$~g$\cdot$mol$^{-1}$, consistent with the compositional saturation observed in the nitrogen content.
