...
\textcolor{red}{this could be bc the nitrogen affects plasma trajectroy and thus it will measure different masses at differetn pressures, further it makes sense bc at further distances where teh plasma expanded the effect doesnt exist}
\begin{figure}[ht]
	\centering
	\begin{subfigure}{.5\textwidth}
		\centering
