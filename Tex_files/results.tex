...
\textcolor{red}{this is where i am currently at writing wise}
\begin{figure}[ht]
	\centering
	\begin{subfigure}{.5\textwidth}
		\centering
...
Additional plot for this can be seen in Appendix \ref{fig:distance_0T_mass/ion}
...
\begin{figure}[ht]
	...
	\label{fig:mag_field_0.25T_mass/ion}
\end{figure}
