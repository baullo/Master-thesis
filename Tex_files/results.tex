...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Metallic case measurements showing (a) the deposited mass after 64 pulses and (b) the ion current averaged over a single pulse, each plotted as a function of magnetic field strength. Data shown for three representative distances (10 cm, 14 cm, and 20 cm), with error bars representing variation within pulses.}
