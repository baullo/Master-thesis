...
\textcolor{red}{[NOTE: Add discussion of apparent inconsistency at 14~cm between Figure~\ref{fig:pressure_0.25T_mass/ion}a trend (constant mass flux vs pressure) and observed film thicknesses. Potential explanations: spatial gradients between QCM/substrate positions, pulse-to-pulse variability (Table~4.1), cathode conditioning effects between runs, nitrogen incorporation affecting $M_{\text{eff}}$.]}
